...
### [[]{.icon--med-lg .icon--arrow-up .heading-item__icon}](https://help.tableau.com/current/server/en-us/cli_start_tsm.htm#){.heading-item__link .print-hidden} Synopsis
...
### [[]{.icon--med-lg .icon--arrow-up .heading-item__icon}](https://help.tableau.com/current/server/en-us/cli_start_tsm.htm#){.heading-item__link .print-hidden} Option
